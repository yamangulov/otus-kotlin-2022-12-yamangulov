...
interface ConsumerStrategy {
    ...
    fun serialize(source: ClientContext): String
    fun deserialize(value: String, target: ClientContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: ClientEstateProcessor =  ClientEstateProcessor(),
    ...
    private fun sendResponse(context: ClientContext, strategy: ConsumerStrategy, outputTopic: String) {
